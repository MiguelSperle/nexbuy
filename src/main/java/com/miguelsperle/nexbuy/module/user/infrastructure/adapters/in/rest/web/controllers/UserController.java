...
import com.miguelsperle.nexbuy.module.user.infrastructure.adapters.in.rest.dtos.requests.ResetUserPasswordRequest;
import com.miguelsperle.nexbuy.module.user.infrastructure.adapters.in.rest.dtos.requests.UpdateUserPasswordRequest;
import com.miguelsperle.nexbuy.module.user.infrastructure.adapters.in.rest.dtos.requests.UpdateUserRequest;
import com.miguelsperle.nexbuy.module.user.infrastructure.adapters.in.rest.dtos.requests.UpdateUserToVerifiedRequest;
import com.miguelsperle.nexbuy.module.user.infrastructure.adapters.in.rest.dtos.responses.GetAuthenticatedUserLegalPersonResponse;
import com.miguelsperle.nexbuy.module.user.infrastructure.adapters.in.rest.dtos.responses.GetAuthenticatedUserNaturalPersonResponse;
