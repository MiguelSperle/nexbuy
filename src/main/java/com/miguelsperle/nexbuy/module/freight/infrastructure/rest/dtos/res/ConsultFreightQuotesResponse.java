package com.miguelsperle.nexbuy.module.freight.infrastructure.rest.dtos.res;

import com.fasterxml.jackson.databind.JsonNode;
import com.miguelsperle.nexbuy.module.freight.application.usecases.io.outputs.ConsultFreightQuotesUseCaseOutput;
import com.miguelsperle.nexbuy.module.freight.infrastructure.rest.dtos.res.complement.DeliveryComplementResponse;
import com.miguelsperle.nexbuy.shared.domain.utils.DecimalUtils;
import com.miguelsperle.nexbuy.shared.infrastructure.configurations.json.Json;
...
public record ConsultFreightQuotesResponse(
    ...
    public static List<ConsultFreightQuotesResponse> from(ConsultFreightQuotesUseCaseOutput consultFreightQuotesUseCaseOutput) {
        ...
        final JsonNode root = Json.readTree(consultFreightQuotesUseCaseOutput.response(), JsonNode.class);
